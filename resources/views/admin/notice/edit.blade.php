                ...
                <form action="{{ route('admin.notice.update', $notice->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview" class="image-preview">
                            ...
                            <input type="hidden" name="old_image" value="{{ $notice->image }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Title</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="date" value="{{ $notice->date }}" class="form-control datepicker">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="priority_number" value="{{ $notice->priority_number }}"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <select name="status" class="form-control">
                            <option @selected($notice->status === 1) value="1">Active</option>
                            <option @selected($notice->status === 0) value="0">InActive</option>
                        </select>
                    </div>
...
@push('admin-js')
    ...
    <script>
        $(document).ready(function() {
            $('.image-preview').css({
                'background-image': 'url({{ asset($notice->image) }})',
