...
@section('admin-content')
    <section class="section">
        <div class="section-header">
            <h1>Create Management Committee</h1>
        </div>
        <div class="card card-primary">
            <div class="card-header">
                <h4>Create Management Committee</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.management-committee.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
