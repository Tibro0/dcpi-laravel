...
@push('admin-css')
    <title>Admin | Social Update</title>
@endpush
            ...
            <div class="card-body">
                <form action="{{ route('admin.social-link.update', $socialLink->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Icon</label>
                        <input type="text" name="icon" value="{{ $socialLink->icon }}" class="form-control">
                    ...
                    <div class="form-group">
                        <label>URL</label>
                        <input type="text" name="url" value="{{ $socialLink->url }}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
