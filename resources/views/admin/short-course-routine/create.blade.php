...
@section('admin-content')
    <section class="section">
        <div class="section-header">
            <h1>Create Short Course Routine</h1>
        </div>
        <div class="card card-primary">
            <div class="card-header">
                <h4>Create Short Course Routine</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.short-course-routine.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
