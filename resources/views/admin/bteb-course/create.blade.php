...
@section('admin-content')
    <section class="section">
        <div class="section-header">
            <h1>Create BTEB Course</h1>
        </div>
        <div class="card card-primary">
            <div class="card-header">
                <h4>Create BTEB Course</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.bteb-course.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
