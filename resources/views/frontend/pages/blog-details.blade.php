...
@push('frontend-css')
    <title>Educenter | Blog Details</title>
@endpush
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mb-4">
                    <img src="{{ asset($blog->image) }}" alt="blog-thumb" class="img-fluid w-100">
                </div>
                <div class="col-12">
                    <ul class="list-inline">
                        <li class="list-inline-item mr-4 mb-3 mb-md-0 text-light"><span
                                class="font-weight-bold mr-2">Post:</span>{{ $blog->category }}</li>
                        <li class="list-inline-item mr-4 mb-3 mb-md-0 text-light">
                            {{ date('F d, Y', strToTime($blog->date)) }}</li>
                ...
                <div class="col-12">
                    <form action="#" class="row">
                        ...
                        <div class="col-sm-6">
                            <input type="email" class="form-control mb-4" id="mail" name="mail"
